class Solution {
    int index; // this index traverse the string in one pass, between different level of recursion
    public int calculate(String s) {
        index = 0; // Initialization should be here
        return calc(s);
    }
    ...
    private int calc(String s) {
        ...
        while (index < s.length()) {
            char c = s.charAt(index++); //System.out.println(c);
